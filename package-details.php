...
<html>
<head>
    <title>Agencia de Turismo Cerrato | Detalles del paquete</title>
...
<div class="banner-3">
    <div class="container">
        <h1 class="wow zoomIn animated" data-wow-delay=".5s">Agencia de Turismo Cerrato - Detalles del paquete</h1>
    </div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
<div class="selectroom">
    <div class="container">
        ...
        <?php } else if ($msg) { ?>
            <div class="succWrap"><strong>COMPLETADO</strong>: <?php echo htmlentities($msg); ?></div>
        <?php } ?>
        <?php
        $pid = intval($_GET['pkgid']);
                ...
                <form name="book" method="post">
                    <div class="selectroom_top">
                        ...
                        <div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
                            ...
                            <div class="hotels">
                                <h3>Ver Hoteles Disponibles</h3>
                                <a href="hoteles.php?pkgid=<?php echo urlencode($result->PackageId); ?>" class="btn btn-primary">Ver Hoteles</a>
                            </div>
                        </div>
                    ...
                    <div class="selectroom_top">
                        <h2>Viajes</h2>
                        <div class="selectroom-info animated wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
                            <ul>
                                <li class="spe">
