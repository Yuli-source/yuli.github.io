...
$error="La identificación de correo electrónico o el número de móvil no son válidos";	
}
}
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TMS-Sistema de Gestión Turística</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Recuperar contraseña</h3>
	...
	<p style="width: 350px;">
			...
			<b>No. Celular</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Registre número celular" required="">
	</p> 
